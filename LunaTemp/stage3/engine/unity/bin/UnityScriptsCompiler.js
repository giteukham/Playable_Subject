...
if ( TRACE ) { TRACE( "DG.Tweening.DOTweenModuleUtils.Physics#CreateDOTweenPathTween", this ); }
    ...
    Bridge.define("DragAndDropManager", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "DragAndDropManager#init", this ); }
        ...
        methods: {
            ...
            Awake: function () {
if ( TRACE ) { TRACE( "DragAndDropManager#Awake", this ); }
...
if ( TRACE ) { TRACE( "DragAndDropManager#StartDrag", this ); }

                if (UnityEngine.EventSystems.EventSystem.current.IsPointerOverGameObject()) {
                    this.EndDrag(stuff);
                } else if (!(UnityEngine.MonoBehaviour.op_Inequality(this.currentDraggedStuff, null)) && !(UnityEngine.MonoBehaviour.op_Equality(GameManager.Instance, null))) {
            ...
            Drag: function (stuff) {
if ( TRACE ) { TRACE( "DragAndDropManager#Drag", this ); }
...
if ( TRACE ) { TRACE( "DragAndDropManager#EndDrag", this ); }
    ...
    Bridge.define("EffectsManager", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "EffectsManager#init", this ); }
        ...
        methods: {
            ...
            Awake: function () {
if ( TRACE ) { TRACE( "EffectsManager#Awake", this ); }
...
if ( TRACE ) { TRACE( "EffectsManager#InitializePools", this ); }
                ...
                for (var i = 0; i < this.poolSize; i = (i + 1) | 0) {
                    var clearParticle = UnityEngine.Object.Instantiate(UnityEngine.GameObject, this.rowClearParticlePrefab, this.transform);
                    clearParticle.SetActive(false);
                    this.rowClearParticlePool.Enqueue(clearParticle);
                    var gootText = UnityEngine.Object.Instantiate(UnityEngine.GameObject, this.goodTextPrefab, this.transform);
                    if (UnityEngine.Component.op_Equality(gootText.GetComponent(UnityEngine.SpriteRenderer), null)) {
                        UnityEngine.Debug.LogError$2("goodTextPrefab\uc5d0 SpriteRenderer \ucef4\ud3ec\ub10c\ud2b8\uac00 \uc5c6\uc2b5\ub2c8\ub2e4");
                    }
                    gootText.SetActive(false);
                    this.goodTextPool.Enqueue(gootText);
                }
            },
...
if ( TRACE ) { TRACE( "EffectsManager#PlayRowClearEffect", this ); }
...
if ( TRACE ) { TRACE( "EffectsManager#PlayGoodTextEffect", this ); }
                ...
                if (!(UnityEngine.Component.op_Equality(spriteRenderer, null))) {
                    ...
                    DG.Tweening.TweenSettingsExtensions.Append(sequence, DG.Tweening.DOTweenModuleSprite.DOFade(spriteRenderer, 1.0, 0.2));
                    DG.Tweening.TweenSettingsExtensions.AppendInterval(sequence, 0.4);
                    DG.Tweening.TweenSettingsExtensions.Append(sequence, DG.Tweening.DOTweenModuleSprite.DOFade(spriteRenderer, 0.0, 0.2));
...
if ( TRACE ) { TRACE( "EffectsManager#GetFromPool", this ); }
...
if ( TRACE ) { TRACE( "EffectsManager#ReturnToPoolAfterDuration", this ); }
    ...
    Bridge.define("GameManager", {
        ...
        fields: {
            idleTimeThreshold: 0,
            idleTimer: 0,
            dragCountForEndCard: 0,
            dragCountForStoreOpen: 0,
            currentDragCount: 0
        },
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "GameManager#init", this ); }
                ...
                this.idleTimer = 0.0;
                this.dragCountForEndCard = 20;
                this.dragCountForStoreOpen = 8;
                this.currentDragCount = 0;
            }
        },
        methods: {
...
if ( TRACE ) { TRACE( "GameManager#OnPlayerInteraction", this ); }
            ...
            /*GameManager.TriggerAppStoreOpen start.*/
            TriggerAppStoreOpen: function () {
if ( TRACE ) { TRACE( "GameManager#TriggerAppStoreOpen", this ); }

                Luna.Unity.Playable.InstallFullGame();
            },
            /*GameManager.TriggerAppStoreOpen end.*/

            /*GameManager.OnStuffDragged start.*/
            OnStuffDragged: function () {
if ( TRACE ) { TRACE( "GameManager#OnStuffDragged", this ); }

                this.currentDragCount = (this.currentDragCount + 1) | 0;
                if (this.currentDragCount === this.dragCountForStoreOpen) {
                    this.TriggerAppStoreOpen();
                }
                if (this.currentDragCount >= this.dragCountForEndCard) {
                    UIManager.Instance.ShowEndCard(true);
                }
            },
            /*GameManager.OnStuffDragged end.*/
    ...
    Bridge.define("GridManager", {
        ...
        statics: {
            ...
            ctors: {
                init: function () {
if ( TRACE ) { TRACE( "GridManager#init", this ); }
...
if ( TRACE ) { TRACE( "GridManager#init", this ); }
        ...
        methods: {
            ...
            OnValidate: function () {
if ( TRACE ) { TRACE( "GridManager#OnValidate", this ); }
            ...
            Awake: function () {
if ( TRACE ) { TRACE( "GridManager#Awake", this ); }
            ...
            Start: function () {
if ( TRACE ) { TRACE( "GridManager#Start", this ); }
            ...
            CreateGrid: function () {
if ( TRACE ) { TRACE( "GridManager#CreateGrid", this ); }
...
if ( TRACE ) { TRACE( "GridManager#GetWrongIndexes", this ); }
...
if ( TRACE ) { TRACE( "GridManager#Shuffle", this ); }
...
if ( TRACE ) { TRACE( "GridManager#CheckRowClearance", this ); }
...
if ( TRACE ) { TRACE( "GridManager#ClearAndHide", this ); }
...
if ( TRACE ) { TRACE( "GridManager#MoveRemainingRowsDown", this ); }
...
if ( TRACE ) { TRACE( "GridManager#isRowClearedByRowIndex", this ); }
...
if ( TRACE ) { TRACE( "Slot#Initialize", this ); }
...
if ( TRACE ) { TRACE( "Slot#PlaceStuff", this ); }
            ...
            ClearStuff: function () {
if ( TRACE ) { TRACE( "Slot#ClearStuff", this ); }
    ...
    Bridge.define("Stuff", {
        ...
        methods: {
            ...
            Initialize: function (rowIndex, material) {
if ( TRACE ) { TRACE( "Stuff#Initialize", this ); }
...
if ( TRACE ) { TRACE( "Stuff#OnMouseDown", this ); }
...
if ( TRACE ) { TRACE( "Stuff#OnMouseDrag", this ); }
            ...
            OnMouseUp: function () {
if ( TRACE ) { TRACE( "Stuff#OnMouseUp", this ); }
...
if ( TRACE ) { TRACE( "UIManager#Start", this ); }
                ...
                if (UnityEngine.GameObject.op_Inequality(this.endCardPanel, null)) {
                    this.endCardPanel.SetActive(false);
                }
            },
            /*UIManager.Start end.*/
...
if ( TRACE ) { TRACE( "UIManager#SetIdlePromptActive", this ); }

                if (UnityEngine.MonoBehaviour.op_Equality(this.idlePromptText, null) || this.endCardPanel.activeSelf) {
                    return;
                }
                if (isActive) {
            ...
            /*UIManager.ShowEndCard start.*/
            ShowEndCard: function (show) {
if ( TRACE ) { TRACE( "UIManager#ShowEndCard", this ); }

                if (!(UnityEngine.GameObject.op_Equality(this.endCardPanel, null))) {
                    this.buttonPulseTween != null ? DG.Tweening.TweenExtensions.Kill(this.buttonPulseTween) : null;
                    this.endCardPanel.SetActive(show);
                    if (show && UnityEngine.Component.op_Inequality(this.playNowButton, null)) {
                        this.playNowButton.localScale = new pc.Vec3( 1, 1, 1 ).clone().scale( 0.9 );
                        this.buttonPulseTween = DG.Tweening.TweenSettingsExtensions.SetLoops(DG.Tweening.Sequence, DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Sequence, DG.Tweening.TweenSettingsExtensions.Append(DG.Tweening.TweenSettingsExtensions.Append(DG.Tweening.DOTween.Sequence(), DG.Tweening.ShortcutExtensions.DOScale(this.playNowButton, 1.1, 0.6)), DG.Tweening.ShortcutExtensions.DOScale(this.playNowButton, 0.9, 0.6)), DG.Tweening.Ease.Linear), -1);
                    }
                }
            },
            /*UIManager.ShowEndCard end.*/
...
if ( TRACE ) { TRACE( "UnityEngine.UI.Extensions.CasualGame.UIParticleSystem#PauseParticleEmission", this ); }
    ...
    var $m = Bridge.setMetadata,
        $n = ["System","UnityEngine","System.Collections.Generic","System.Collections","DG.Tweening","TMPro","UnityEngine.UI","UnityEngine.Audio","DG.Tweening.Core","DG.Tweening.Plugins.Core.PathCore","System.Globalization","DG.Tweening.Plugins.Options"];
    ...
    /*GameManager start.*/
    $m("GameManager", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":2,"n":"OnPlayerInteraction","t":8,"sn":"OnPlayerInteraction","rt":$n[0].Void},{"a":2,"n":"OnStuffDragged","t":8,"sn":"OnStuffDragged","rt":$n[0].Void},{"a":2,"n":"TriggerAppStoreOpen","t":8,"sn":"TriggerAppStoreOpen","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":2,"n":"Instance","is":true,"t":16,"rt":GameManager,"g":{"a":2,"n":"get_Instance","t":8,"rt":GameManager,"fg":"Instance","is":true},"s":{"a":1,"n":"set_Instance","t":8,"p":[GameManager],"rt":$n[0].Void,"fs":"Instance","is":true},"fn":"Instance"},{"a":1,"n":"currentDragCount","t":4,"rt":$n[0].Int32,"sn":"currentDragCount","box":function ($v) { return Bridge.box($v, System.Int32);}},{"at":[new UnityEngine.TooltipAttribute("\uc774 \ud69f\uc218\ub9cc\ud07c \ub4dc\ub798\uadf8\ud558\uba74 \uc5d4\ub4dc \uce74\ub4dc\ub97c \ud45c\uc2dc\ud569\ub2c8\ub2e4."),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"dragCountForEndCard","t":4,"rt":$n[0].Int32,"sn":"dragCountForEndCard","box":function ($v) { return Bridge.box($v, System.Int32);}},{"at":[new UnityEngine.TooltipAttribute("\uc774 \ud69f\uc218\ub9cc\ud07c \ub4dc\ub798\uadf8\ud558\uba74 \uc2a4\ud1a0\uc5b4\ub85c \uc774\ub3d9\ud569\ub2c8\ub2e4."),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"dragCountForStoreOpen","t":4,"rt":$n[0].Int32,"sn":"dragCountForStoreOpen","box":function ($v) { return Bridge.box($v, System.Int32);}},{"at":[new UnityEngine.HeaderAttribute("\uac8c\uc784 \ud50c\ub808\uc774 \uc124\uc815"),new UnityEngine.TooltipAttribute("\uc774 \uc2dc\uac04(\ucd08) \ub3d9\uc548 \uc870\uc791\uc774 \uc5c6\uc73c\uba74 \uc548\ub0b4 \ubb38\uad6c\ub97c \ud45c\uc2dc\ud569\ub2c8\ub2e4."),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"idleTimeThreshold","t":4,"rt":$n[0].Single,"sn":"idleTimeThreshold","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"idleTimer","t":4,"rt":$n[0].Single,"sn":"idleTimer","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"backing":true,"n":"<Instance>k__BackingField","is":true,"t":4,"rt":GameManager,"sn":"Instance"}]}; }, $n);
    /*GameManager end.*/
    ...
    /*UIManager start.*/
    $m("UIManager", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Awake","t":8,"sn":"Awake","rt":$n[0].Void},{"a":2,"n":"SetIdlePromptActive","t":8,"pi":[{"n":"isActive","pt":$n[0].Boolean,"ps":0}],"sn":"SetIdlePromptActive","rt":$n[0].Void,"p":[$n[0].Boolean]},{"a":2,"n":"ShowEndCard","t":8,"pi":[{"n":"show","pt":$n[0].Boolean,"ps":0}],"sn":"ShowEndCard","rt":$n[0].Void,"p":[$n[0].Boolean]},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":2,"n":"Instance","is":true,"t":16,"rt":UIManager,"g":{"a":2,"n":"get_Instance","t":8,"rt":UIManager,"fg":"Instance","is":true},"s":{"a":1,"n":"set_Instance","t":8,"p":[UIManager],"rt":$n[0].Void,"fs":"Instance","is":true},"fn":"Instance"},{"a":1,"n":"buttonPulseTween","t":4,"rt":$n[4].Tween,"sn":"buttonPulseTween"},{"at":[new UnityEngine.HeaderAttribute("\uc5d4\ub4dc \uce74\ub4dc"),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"endCardPanel","t":4,"rt":$n[1].GameObject,"sn":"endCardPanel"},{"at":[new UnityEngine.TooltipAttribute("\uc6c0\uc9c1\uc784\uc774 \ub3c4\ub2ec\ud560 Y \uc704\uce58"),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"endY","t":4,"rt":$n[0].Single,"sn":"endY","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"idlePromptText","t":4,"rt":$n[5].TextMeshProUGUI,"sn":"idlePromptText"},{"a":1,"n":"idlePromptTween","t":4,"rt":$n[4].Tween,"sn":"idlePromptTween"},{"a":1,"n":"isIdleAnimationPlaying","t":4,"rt":$n[0].Boolean,"sn":"isIdleAnimationPlaying","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.TooltipAttribute("\uc2dc\uc791\uc810\uc5d0\uc11c \ub05d\uc810\uae4c\uc9c0 \uac00\ub294 \ub370 \uac78\ub9ac\ub294 \uc2dc\uac04"),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"moveDuration","t":4,"rt":$n[0].Single,"sn":"moveDuration","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.TooltipAttribute("\uc560\ub2c8\uba54\uc774\uc158\uc744 \uc801\uc6a9\ud560 'Play Now' \ubc84\ud2bc"),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"playNowButton","t":4,"rt":$n[1].RectTransform,"sn":"playNowButton"},{"at":[new UnityEngine.HeaderAttribute("\uc560\ub2c8\uba54\uc774\uc158 \uc124\uc815"),new UnityEngine.TooltipAttribute("\uc6c0\uc9c1\uc784\uc774 \uc2dc\uc791\ub420 Y \uc704\uce58"),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"startY","t":4,"rt":$n[0].Single,"sn":"startY","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"at":[new UnityEngine.HeaderAttribute("UI \uc694\uc18c"),new UnityEngine.SerializeFieldAttribute()],"a":1,"n":"textBackGroundObject","t":4,"rt":$n[1].GameObject,"sn":"textBackGroundObject"},{"a":1,"backing":true,"n":"<Instance>k__BackingField","is":true,"t":4,"rt":UIManager,"sn":"Instance"}]}; }, $n);
    /*UIManager end.*/
